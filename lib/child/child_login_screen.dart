...
import 'package:flutter_application_1/child/reset_password_screen.dart';
  ...
  try {
    ...
    if (userCredential.user != null) {
      ...
      FirebaseFirestore.instance
       ...
       Fluttertoast.showToast(msg: 'Log In Successfully'); // show the message succesfully log in 
      });
    }
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            ...
            colorFilter: ColorFilter.mode(
              Colors.white.withOpacity(0.9), // change backround opacity
              BlendMode.srcOver,
            ),
          ),
        ),
                            ...
                            child: Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  forgetPassword(context), // Adding forgetPassword widget here
                                  SecondaryButton(
                                    title: 'Register',
                                    onPressed: () {
